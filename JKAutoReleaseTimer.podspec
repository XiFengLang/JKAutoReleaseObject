#
#  Be sure to run `pod spec lint JKAutoReleaseTimer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/XiFengLang/JKAutoReleaseTimer.git", :tag => "#{s.version}" }
